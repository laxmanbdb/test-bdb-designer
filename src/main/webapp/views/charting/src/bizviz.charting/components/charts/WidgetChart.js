 ...
 * @File: WidgetChart.js
 * @description WidgetChart
 **/
function WidgetChart(m_chartContainer, m_zIndex) {
	this.base = Chart;
	this.base();
...
WidgetChart.prototype = new Chart();
/** @description This method will parse the chart JSON and create a container **/
WidgetChart.prototype.setProperty = function (chartJson) {
...
WidgetChart.prototype.ParseJsonAttributes = function (jsonObject, nodeObject) {
...
WidgetChart.prototype.setFields = function (fieldsJson) {
	try {
...
WidgetChart.prototype.setSeries = function (seriesJson) {
	this.m_seriesNames = [];
...
WidgetChart.prototype.getFields = function () {
	return this.m_fieldsJson;
};
/** @description Getter For DataProvider **/
WidgetChart.prototype.getDataProvider = function () {
	return this.m_dataProvider;
};
/** @description Getter For DataProvider **/
WidgetChart.prototype.eventCallBack = function (event, data, index) {
...
WidgetChart.prototype.getSeriesNames = function () {
...
WidgetChart.prototype.init = function () {
...
WidgetChart.prototype.drawChart = function () {
	this.drawChartFrame();
	this.drawTitle();
	this.drawSubTitle();
	//this.hideCanvas();
...
WidgetChart.prototype.IsDrawingPossible = function() {
	var map = {};
...
WidgetChart.prototype.drawDesignModeCustomChart = function () {
	var temp = this;
...
WidgetChart.prototype.setDesignModeCustomChart = function(){
...
WidgetChart.prototype.getEndY = function () {
...
WidgetChart.prototype.getMarginForTitle = function () {
...
WidgetChart.prototype.getMarginForSubTitle = function () {
...
WidgetChart.prototype.getPreProcessedScript = function () {
	if(this.m_designMode){
		return "";
	}else{
...
WidgetChart.prototype.drawCustomChart = function () {
	var temp = this;
	var datasetId = temp.m_associatedwidgetdata;
	var spaceKey = window.sessionStorage.getItem('bvz_spacekey');
	var
	REQ_URL = "/widget/getWidget/",
	REQ_DATA = { id : datasetId, spaceKey: spaceKey },
	requestSuccessFn = function (data, success) {
		var _success = data.widgetResp.success;
		if(_success){
		var viewDefinition = JSON.parse(data.widgetResp.bizvizWidget.data);
		var widgetcard = $("<app-widget-card>")
			  .attr("instanceid", "WidgetChart"+temp.m_objectid)
			  .attr("viewdefinition", JSON.stringify(viewDefinition));
		$("#innerDiv"  + temp.m_objectid).append(widgetcard);
	}
	},
	requestFailedFn = function (data, success) {
		return "Default";
	};
	parent.window.BIZVIZ.SDK.secureRequest(REQ_URL, REQ_DATA, requestSuccessFn, requestFailedFn);
	
};
//# sourceURL=WidgetChart.js