...
.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', 'taToolFunctions', '$sanitize', 'taOptions', '$log',
    ...
    taRegisterTool('ul', {
        display: "<div style='height: 34px;'><input type='color' ng-change='action()' ng-model='color' style='width: 25px;'></div>",
    ...
    taRegisterTool('ol', {
        display: "<div style='height: 34px;'><input type='color' ng-change='action()' ng-model='value' style='width: 25px;'></div>",
        ...
        action: function(){
            ...
            if (!this.$editor().wrapSelection) {
                ...
                return this.$editor().wrapSelection('foreColor', this.value);
            }
        },
        activeState: function(){
            return this.$editor().queryCommandState('bold');
    ...
    taRegisterTool('indent',  {
        ...
        display: "<div class='c-drop-down' dropdown='true' auto-close='outsideClick'><a dropdown-toggle='true' style='color: #000000;'><i class='fa fa-font'></i><i class='fa fa-caret-down'></i></a><ul class='c-drop-down__menu c-drop-down__menu--left dropdown-menu' style='min-width: 100px;'><li ng-repeat='o in options' ng-click='action($event, o.value)' style='padding: 4px;text-align: center;border-bottom: 1px solid black;'>{{o.key}}</li></ul></div>",
        ...
        options: [{
			...
			"key": "Monotype Corsiva",
			"value": "Monotype Corsiva"
		}, {
			"key": "Papyrus",
			"value": "Papyrus"
		}, {
			"key": "'Raleway', sans-serif",
			"value": "Raleway"
		},{
			"key": "Roboto",
			"value": "Roboto"
    ...
    taRegisterTool('outdent', {
        ...
        display: "<div class='c-drop-down' dropdown='true' auto-close='outsideClick'><a dropdown-toggle='true' style='color: #000000;'><i class='fa fa-text-height'></i><i class='fa fa-caret-down'></i></a><ul class='c-drop-down__menu c-drop-down__menu--left dropdown-menu'><li ng-repeat='o in options' ng-click='action($event, o.value)' style='padding: 4px;text-align: center;border-bottom: 1px solid black;font-size: {{o.css}}'>{{o.name}}</li></ul></div>",
